//! Windows named-pipe service for browser native messaging.
//!
//! Browser-extension screenshot ingestion and capture-session registration
//! use the NMH pipe in this module.
//!
