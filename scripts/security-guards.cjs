...
const COMMAND_TIERS = {
  ...
  'commands::database_mode::storage_get_database_mode_metadata': 'session_required',
  'commands::database_mode::storage_check_database_mode_eligibility': 'session_required',
  'commands::database_mode::storage_transition_wal_to_delete': 'session_required',
  ...
  'commands::credential::credential_get_background_processing_enabled': 'public',
  'commands::credential::credential_set_background_processing_enabled': 'session_required',
  'background_scheduler::background_scheduler_status': 'public',
  ...
  'model_management::get_model_inventory': 'session_required',
